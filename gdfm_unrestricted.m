...
function [chi,CL,v,C1,eta1,xi,sigma,mu] = gdfm_unrestricted(X,q,k,w,nlagsimp,idvar,qq,nrepli,dummy_std)
...
chi=chi';
xi = nan(T, n);
% Compute idiosyncratic components (same dimensions as chi)
xi = z(k+1:T, :) - chi;  % Both are (T-k) × n
