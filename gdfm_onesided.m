...
function [chi, xi, X, factors, loadings, forecast_chi, vardec, D_X] = gdfm_onesided(panel, q, r, m, h, steps, vardec_opt)
...
% Check for valid factor dimensions
if q > n 
...
% Handle defaults if inputs are missing or empty
...
if nargin < 7 || isempty(vardec_opt)
    vardec_opt = 1;  
end
...
% Validate output count against vardec_opt
